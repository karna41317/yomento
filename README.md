## tltr;
```
git clone git@github.com:karna41317/yemonto.git my_yemonto
cd my_yemonto
yarn install
...
* **TODO** :star: added code-push, left with Code Signing setup: Code-push is for instant JavaScript and images update
