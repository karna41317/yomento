...
export type AnimatedViewStyleProp = $PropertyType<$PropertyType<Animated.View, 'props'>,
  'style'>;
export type AnimatedTextStyleProp = $PropertyType<$PropertyType<Animated.Text, 'props'>,
  'style'>;
...
export type NavigationRouter<State, Action, Options> = {
  ...
  getActionForPathAndParams: (
    path: string,
    params?: NavigationParams) => ?Action,
...
export type HeaderProps = {
  ...
  mode: HeaderMode,
  router: NavigationRouter<NavigationState,
    NavigationAction,
...
export type NavigationStyleInterpolator = (
  props: NavigationSceneRendererProps) => AnimatedViewStyleProp;
