...
export function radiusScales (
  ...
  domainMax: number,
  radius: number,): { [variableKey: string]: TickScale } {
  const res = {}
...
export function radarPoints (
  ...
  offsetAngles: { [variableKey: string]: number },): Array<{ setKey: string, points: Array<RadarPoint> }> {
