...
export class Slider extends PureComponent {
  ...
  render () {
    ...
    return (
      <View {...other} style={[mainStyles.container, style]}
  ...
  _handleStartShouldSetPanResponder = (e: Object,
                                       /*gestureState: Object*/): boolean => {
  ...
  _handleMeasure = (name: string, x: Object) => {
    ...
    if (currentSize && width === currentSize.width &&
    ...
    if (this.props.step) {
      return Math.max(this.props.minimumValue,
        Math.min(this.props.maximumValue,
          this.props.minimumValue + Math.round(ratio *
          (this.props.maximumValue - this.props.minimumValue) /
  ...
  _getTouchOverflowSize = () => {
    ...
    if (state.allMeasured === true) {
      size.width = Math.max(0, props.thumbTouchSize.width -
        state.thumbSize.width)
      size.height = Math.max(0, props.thumbTouchSize.height -
  ...
  _thumbHitTest = (e: Object) => {
    ...
    return thumbTouchRect.containsPoint(nativeEvent.locationX,
