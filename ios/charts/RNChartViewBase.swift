...
open class RNChartViewBase: UIView, ChartViewDelegate {
    ...
    func setLegend(_ config: NSDictionary) {
        ...
        if json["textColor"].string != nil {
            legend.textColor = RCTConvert.uiColor(json["textColor"].stringValue);
        }
    ...
    func setChartDescription(_ config: NSDictionary) {
        ...
        if json["textColor"].string != nil {
            chartDescription.textColor = RCTConvert.uiColor(json["textColor"].stringValue)
        }
    ...
    func setCommonAxisConfig(_ axis: AxisBase, config: JSON) {
        ...
        // style
        if config["textColor"].string != nil {
            axis.labelTextColor = RCTConvert.uiColor(config["textColor"].stringValue)
        }
        ...
        if config["gridColor"].string != nil {
            axis.gridColor = RCTConvert.uiColor(config["gridColor"].stringValue)
        }
        ...
        if config["limitLines"].array != nil {
            ...
            for limitLineConfig in limitLinesConfig {
                ...
                if limitLineConfig["limit"].double != nil {
                    ...
                    if (limitLineConfig["lineColor"].string != nil) {
                        limitLine.lineColor = RCTConvert.uiColor(limitLineConfig["lineColor"].stringValue)
                    }
    ...
    func setMarker(_ config: NSDictionary) {
        ...
        let balloonMarker = BalloonMarker(
            color: RCTConvert.uiColor(json["markerColor"].stringValue),
            font: markerFont,
            textColor: RCTConvert.uiColor(json["textColor"].stringValue))
